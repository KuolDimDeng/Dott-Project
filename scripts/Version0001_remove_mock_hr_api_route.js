/**
 * Script: Version0001_remove_mock_hr_api_route.js
 * 
 * Description:
...
async function updateScriptRegistry() {
  try {
    ...
    const entry = `
| Version0001_remove_mock_hr_api_route.js | ${today} | Completed | Removed mock HR API route |
`;
    
    if (!registry.includes('Version0001_remove_mock_hr_api_route.js')) {
...
`;
  ...
  await writeFileAsync(targetFile, replacementContent, 'utf8');
