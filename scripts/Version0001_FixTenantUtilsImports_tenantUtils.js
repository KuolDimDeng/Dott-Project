...
/**
 * Version: 1.0
 * Purpose: Fix import/export issues in tenantUtils.js
 * Target: frontend/pyfactor_next/src/utils/tenantUtils.js
 * Dependencies: aws-amplify v6
 * 
 * Changes:
 * 1. Update AppCache import to use correct path
...
${currentContent.split('export const getTenantId')[1]}`;

// Write new content
await fs.writeFile(TARGET_FILE, newContent);

console.log('Successfully updated tenantUtils.js');
