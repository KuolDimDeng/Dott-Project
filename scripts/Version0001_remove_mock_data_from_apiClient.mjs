/**
 * Script: Version0001_remove_mock_data_from_apiClient.mjs
 * 
 * Description:
...
async function updateScriptRegistry() {
  try {
    ...
    const entry = `
| Version0001_remove_mock_data_from_apiClient.mjs | ${today} | Completed | Removed mock data functionality from employeeApi in apiClient.js |
`;
    
    if (!registry.includes('Version0001_remove_mock_data_from_apiClient.mjs')) {
