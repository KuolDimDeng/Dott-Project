/**
 * Script: run_mock_data_removal.mjs
 * 
 * Description:
...
const scripts = [
  'Version0001_remove_mock_data_from_apiClient.mjs',
  'Version0001_remove_mock_hr_api_route.mjs',
  'Version0001_remove_mock_data_from_EmployeeManagement.mjs'
];
