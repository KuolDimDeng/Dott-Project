...
export default function MobileHeroSlideshow() {
  ...
  }, [isPaused, placeholderImages.length]);
  ...
  return (
    <div className="relative w-full px-4 py-8">
      <div className="relative h-[400px] md:h-[500px] flex items-center justify-center">
        {/* Main slide - mobile optimized */}
        <div className="relative w-full h-full">
          <div className="relative w-full h-full rounded-xl overflow-hidden shadow-xl bg-gray-50">
            <Image
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
              ...
              <p className="text-sm opacity-95">{placeholderImages[currentIndex].description}</p>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-2 rounded-full shadow-lg transition-all duration-200 hover:scale-110 z-30"
        ...
        <button
          onClick={goToNext}
          className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-2 rounded-full shadow-lg transition-all duration-200 hover:scale-110 z-30"
      ...
      <div className="flex justify-center items-center mt-4 space-x-1.5">
        ...
        <div className="ml-3 flex items-center text-xs text-gray-500">
          ...
          <span className="text-xs">
            {isPaused ? t('heroSlideshow.controls.paused', 'Paused') : t('heroSlideshow.controls.autoPlaying', 'Auto')}
          </span>
        </div>
      </div>
    </div>
