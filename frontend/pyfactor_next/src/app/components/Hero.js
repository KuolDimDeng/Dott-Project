          ...
          <div className="mt-16">
            ...
            <div className="mt-6 grid grid-cols-2 gap-8 md:grid-cols-4">
              <div className="flex justify-center grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition duration-300">
                <img src="/static/images/logos/logo1.png" alt="Company logo" width={140} height={40} />
              </div>
              <div className="flex justify-center grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition duration-300">
                <img src="/static/images/logos/logo2.png" alt="Company logo" width={140} height={40} />
              </div>
              <div className="flex justify-center grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition duration-300">
                <img src="/static/images/logos/logo3.png" alt="Company logo" width={140} height={40} />
              </div>
              <div className="flex justify-center grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition duration-300">
                <img src="/static/images/logos/logo4.png" alt="Company logo" width={140} height={40} />
              </div>
            </div>
          </div>
        </div>
