...
export const routeRegistry = {
  // Dashboard Views
  'dashboard': {
    component: enhancedLazy(() => import('../components/dashboards/BusinessOverviewDashboardRecharts'), 'Business Overview'),
    title: 'Dashboard',
    description: 'Business overview dashboard'
  },
  'main-dashboard': {
    component: enhancedLazy(() => import('../components/dashboards/BusinessOverviewDashboardRecharts'), 'Main Dashboard'),
    title: 'Dashboard',
  ...
  // Discover Routes
  'marketplace': {
    component: enhancedLazy(() => import('../components/marketplace/MarketplaceDashboard'), 'Discover'),
    title: 'Discover',
  ...
  'marketplace-orders': {
    ...
    title: 'My Orders',
    description: 'View your orders from discovered businesses'
  },
  'marketplace-listing': {
