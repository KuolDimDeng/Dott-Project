  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow">
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm">Create and manage vendor bills, track expenses, and monitor payment status.</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <FieldTooltip text="Select the vendor who sent this bill. Start typing to search by vendor name or number." />
              </label>
              <div className="relative">
                <input
                  type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Currency
                <FieldTooltip text="Select the currency for this bill. This should match the vendor's invoice currency." />
              </label>
              <select
                name="currency"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Bill Date
                <FieldTooltip text="The date shown on the vendor's bill or invoice. This is when the vendor issued the bill." />
              </label>
              <input
                type="date"
                className="w-full p-2 border border-gray-300 rounded-md"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Due Date
                <FieldTooltip text="The payment due date for this bill. This determines when payment should be made to avoid late fees." />
              </label>
              <input
                type="date"
                className="w-full p-2 border border-gray-300 rounded-md"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                P.O./S.O.
                <FieldTooltip text="Purchase Order or Sales Order number if this bill relates to a specific order. Optional field for reference." />
              </label>
              <input
                type="text"
                name="poso_number"
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Notes
                <FieldTooltip text="Add any additional information, special instructions, or internal notes about this bill." />
              </label>
              <textarea
                name="notes"
                rows="4"
