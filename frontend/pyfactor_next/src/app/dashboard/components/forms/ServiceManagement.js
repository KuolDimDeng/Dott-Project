...
const ServiceManagement = ({ salesContext = false, newService: isNewService = false }) => {
  const [activeTab, setActiveTab] = useState(isNewService ? 0 : 2);
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Typography variant="h4" gutterBottom>
        {salesContext ? 'Sales Services' : 'Service Management'}
      </Typography>
