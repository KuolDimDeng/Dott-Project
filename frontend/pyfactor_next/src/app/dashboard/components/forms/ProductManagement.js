...
const ProductManagement = ({ salesContext = false, newProduct: isNewProduct = false }) => {
  const [activeTab, setActiveTab] = useState(isNewProduct ? 0 : 2);
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Typography variant="h4" gutterBottom>
        {salesContext ? 'Sales Products' : 'Product Management'}
      </Typography>
