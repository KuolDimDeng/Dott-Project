                      ...
                      <div className="grid grid-cols-1 gap-4 mb-4">
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <FieldTooltip text="Select the type of tax form (W-2 for wage statements, W-4 for withholding, 1099 for contractors, etc.)." />
                          </label>
                          <select
                            name="form_type"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <FieldTooltip text="Enter the tax year this form applies to. For W-2s, this is the year wages were earned." />
                          </label>
                          <input
                            type="number"
                            name="tax_year"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">
                            Filing Status
                            <FieldTooltip text="Select the employee's filing status for tax withholding purposes. This affects federal tax calculations." />
                          </label>
                          <select
                            name="filing_status"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">
                            State (if applicable)
                            <FieldTooltip text="Select the state if this is a state tax form. Leave blank for federal forms like W-2 or W-4." />
                          </label>
                          <select
                            name="state_code"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">
                            Form File
                            <FieldTooltip text="Upload a scanned copy or digital version of the tax form. Accepted formats: PDF, JPG, PNG." />
                          </label>
                          <input
                            type="file"
                            accept=".pdf,.jpg,.png"
