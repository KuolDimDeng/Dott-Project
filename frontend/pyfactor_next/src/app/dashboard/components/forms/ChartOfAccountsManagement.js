    ...
    <div className="bg-white p-6 rounded-lg shadow">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 text-sm">Manage your accounting structure with categories, accounts, and hierarchical organization.</p>
        </div>
                    ...
                    <div className="space-y-6">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Account Type
                          <FieldTooltip text="Select the type of account (Asset, Liability, Equity, Revenue, or Expense). This determines how the account affects your financial statements." />
                        </label>
                        <select
                          multiple
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Status
                          <FieldTooltip text="Filter accounts by their active status. Active accounts can be used for transactions, while inactive accounts are hidden from most views." />
                        </label>
                        <select
                          className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
