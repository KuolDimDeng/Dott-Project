...
const SalesDashboard = enhancedLazy(() => import('./dashboards/SalesDashboardEnhanced.js'), 'Sales Dashboard');
...
const ProductManagement = enhancedLazy(() => import('@/domains/products/components/ProductManagement'), 'Product Management');
