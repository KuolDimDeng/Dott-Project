...
export default function CustomersPage() {
  ...
  const handleCustomerCreated = (newCustomer) => {
    logger.info('[CustomersPage] New customer created:', newCustomer);
    setNeedsRefresh(true);
    setActiveTab('list');
    updateUrlParams('list');
  };
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="border-b border-gray-300 mb-6 bg-white shadow-sm rounded-t-lg">
          <nav className="flex -mb-px max-w-4xl mx-auto">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1
1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
              </svg>
              List Customers
            </button>
            <button 
