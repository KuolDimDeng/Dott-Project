    ...
    if (accessToken) {
      ...
      try {
        ...
        if (backendResponse.ok) {
          ...
          // Determine onboarding status - if user has tenant, they don't need onboarding
          const hasCompletedOnboarding = backendTenantId && (
          ...
          profileData = {
            ...
            onboardingCompleted: finalTenantId && hasCompletedOnboarding ? true :
                               (user.onboardingCompleted !== undefined ? user.onboardingCompleted : 
                                (backendUser.onboarding_completed === true)),
            currentStep: finalTenantId && hasCompletedOnboarding ? 'completed' :
