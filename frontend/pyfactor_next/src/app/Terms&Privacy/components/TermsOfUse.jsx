  ...
  return (
    <Container maxWidth="md">
      ...
      >
        ...
        <SectionContent>
          Welcome to Dott, a service provided by Pyfactor, LLC. This Terms of Use Agreement
          ("Agreement") governs your use of the Dott website and any related services offered by
          Pyfactor, LLC.
        </SectionContent>

        <SectionTitle>1. Acceptance of Terms</SectionTitle>
        <SectionContent>
          By using Dott, you agree to be bound by this Agreement. If you do not agree to these
        ...
        <SectionContent>
          All content and functionality on Dott is the property of Pyfactor, LLC or its licensors
        ...
        <SectionContent>
          Pyfactor, LLC shall not be liable for any indirect, incidental, special, consequential or
          punitive damages resulting from your use of or inability to use Dott.
        </SectionContent>
