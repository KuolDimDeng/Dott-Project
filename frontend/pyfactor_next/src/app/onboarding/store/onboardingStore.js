        ...
        (set, get) => ({
          ...
          initialize: async () => {
            ...
            try {
              ...
              const errorMsg = error.response?.status === 401 ? APP_CONFIG.errors.messages.unauthorized :
                error.response?.status === 404 ? APP_CONFIG.errors.messages.default :
          ...
          validateStep: (step) => {
            try {
              ...
              const validationRules = {
                [APP_CONFIG.onboarding.steps.INITIAL]: () => !!formData.businessName && !!formData.industry,
                ...
                [APP_CONFIG.onboarding.steps.SETUP]: () => {
                  return formData.selectedPlan === APP_CONFIG.app.plans.defaultPlan || 
