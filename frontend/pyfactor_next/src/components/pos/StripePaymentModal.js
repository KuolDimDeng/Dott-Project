  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex space-x-3">
        <button
          type="submit"
          disabled={!stripe || processing || !cardComplete || fetchingRate}
          className={`flex-1 py-3 px-4 rounded-md font-medium transition-colors ${
            processing || !cardComplete || fetchingRate
        ...
        >
          {processing ? (
            ...
            // Show converted amount if conversion applied, otherwise original amount
            conversionInfo 
              ? `Pay $${conversionInfo.usdAmount.toFixed(2)} USD`
              : `Pay ${formatCurrency(amount, currencyCode, currencySymbol)}`
          )}
        </button>
        <button
          type="button"
          ...
          <div className="p-6">
            {stripePromise ? (
              ...
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Payment System Not Available</h3>
