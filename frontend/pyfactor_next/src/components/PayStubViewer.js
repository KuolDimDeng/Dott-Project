...
export default function PayStubViewer({ isModal = false, onClose }) {
  ...
  const content = (
    <div className="space-y-6">
      ...
      {selectedPayStub && (
        <div className="absolute inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
  ...
  if (isModal) {
    return (
      <div className="absolute inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full z-[9999] flex items-center justify-center p-4">
