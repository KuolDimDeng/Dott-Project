/**
 * Script: Version0001_remove_mock_data_from_EmployeeManagement.mjs
 * 
 * Description:
...
async function updateScriptRegistry() {
  try {
    ...
    const entry = `
| Version0001_remove_mock_data_from_EmployeeManagement.mjs | ${today} | Completed | Removed mock data functionality from EmployeeManagement component |
`;
    
    if (!registry.includes('Version0001_remove_mock_data_from_EmployeeManagement.mjs')) {
