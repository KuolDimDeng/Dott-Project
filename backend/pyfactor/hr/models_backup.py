...
class Employee(AbstractUser):
    ...
    state = models.CharField(max_length=2, blank=True, null=True, help_text="State code (e.g., CA, NY)")
    country = models.CharField(max_length=100, default='USA')
    
    # Work location (may differ from residence)
    work_street = models.CharField(max_length=200, null=True, blank=True)
    work_city = models.CharField(max_length=100, blank=True, null=True)
    work_state = models.CharField(max_length=2, blank=True, null=True, help_text="Work state code")
    work_postcode = models.CharField(max_length=20, blank=True, null=True)
    work_county = models.CharField(max_length=100, blank=True, null=True, help_text="Work county/parish")
    residence_state = models.CharField(max_length=2, blank=True, null=True, help_text="State of residence")
