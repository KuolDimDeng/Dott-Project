    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_number', hr.custom_fields.EncryptedCharField(default=None, max_length=255)),
                ('bank_account_number', hr.custom_fields.EncryptedCharField(blank=True, max_length=255, null=True)),
                ('tax_id_number', hr.custom_fields.EncryptedCharField(blank=True, max_length=255, null=True)),
                ...
                ('business', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='business_employees', to='business.business')),
