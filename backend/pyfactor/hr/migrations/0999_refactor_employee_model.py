...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hr', '0026_employee_direct_deposit_employee_vacation_days_per_year_employee_vacation_time'),
    ...
    operations = [
        ...
        migrations.RunSQL(
            ...
            SELECT 
                ...
                security_number_type,
                ssn_last_four,
                stripe_person_id,
                stripe_account_id,
                ssn_stored_in_stripe,
                direct_deposit,
                vacation_time,
