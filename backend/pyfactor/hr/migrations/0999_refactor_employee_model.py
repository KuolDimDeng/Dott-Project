    ...
    operations = [
        ...
        migrations.RunSQL(
            ...
            SELECT 
                ...
                city,
                state,
                COALESCE(postcode, zip_code) as zip_code,
                country,
                employment_type,
                department,
                job_title,
                ...
                COALESCE(emergency_contact_name, emergency_contact) as emergency_contact_name,
                COALESCE(emergency_contact_phone, emergency_phone) as emergency_contact_phone,
