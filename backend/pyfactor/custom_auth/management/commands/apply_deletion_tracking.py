"""
Django management command to apply deletion tracking migration
"""
from django.core.management.base import BaseCommand
from django.db import connection

class Command(BaseCommand):
    help = 'Apply deletion tracking database migration'

    def handle(self, *args, **options):
        self.stdout.write('Starting deletion tracking migration...\n')
...
"""
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                self.stdout.write(self.style.SUCCESS(f'✅ Added {len(columns)} deletion tracking columns to user table\n'))
                ...
                self.stdout.write(self.style.SUCCESS(f'✅ Created {len(tables)} new tracking tables\n'))
