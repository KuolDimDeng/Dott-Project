#!/usr/bin/env python
"""
Standalone script to populate store_items with REAL African beauty products
This version works without Django setup - connects directly to database
"""
import os
import psycopg2
...
DB_CONFIG = {
    'dbname': os.getenv('DB_NAME', 'dott_local_dev'),
...
def populate_african_beauty_products():
    ...
    print("=" * 60)
    print("POPULATING AFRICAN BEAUTY PRODUCTS - STANDALONE VERSION")
    print("=" * 60)
