#!/usr/bin/env python
"""
Script to create the users_business_details table if it doesn't exist.
"""
...
def create_business_details_table():
    """
    Create the users_business_details table if it doesn't exist.
    """
    logger.info("Checking if users_business_details table exists...")
    ...
    try:
        ...
        logger.error(f"Error creating users_business_details table: {str(e)}")
        return False

if __name__ == "__main__":
    success = create_business_details_table()
    if success:
