...
Final version that handles all required fields including thumbnail_url
"""
import os
import psycopg2
...
AFRICAN_BEAUTY_PRODUCTS = [
    ...
    },
    {
        ...
        'size': '500ml',
        'unit': 'bottle',
        'image_url': 'https://m.media-amazon.com/images/I/51MiKdgx6RL._SL1000_.jpg'
    }
]
...
def populate_african_beauty_products():
    ...
    print("=" * 60)
    print("POPULATING AFRICAN BEAUTY PRODUCTS - FINAL VERSION")
    print("=" * 60)
    ...
    try:
        for product in AFRICAN_BEAUTY_PRODUCTS:
            try:
                ...
                # Use image_url for both image_url and thumbnail_url
                ...
                """, [
                    ...
                    image_url,
                    image_public_id,
                    thumbnail_url,  # Add the required thumbnail_url
                ])
                ...
                error_count += 1
                print(f"❌ Error adding {product['name']}: {str(e)[:80]}")
                conn.rollback()
