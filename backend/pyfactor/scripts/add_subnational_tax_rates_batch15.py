...
Batch 15: Next 20 countries - ONLY add sub-national rates, DO NOT modify country rates
"""
...
# Batch 15: Focus ONLY on countries with actual sub-national tax variations
COUNTRIES_WITH_STATE_TAXES = {
    'AF': {  # Afghanistan - Limited tax system
        ...
        'states': {
            # Afghanistan has limited tax administration capabilities
        }
    },
    'BD': {  # Bangladesh - Uniform VAT
        'name': 'Bangladesh',
        'tax_type': 'vat',
        'federal_rate': None,  # DO NOT MODIFY - leave existing rate
        'states': {
            # Bangladeshi VAT is uniform across all divisions
        }
    },
    'BT': {  # Bhutan - Uniform sales tax
        'name': 'Bhutan',
        'tax_type': 'sales_tax',
        'federal_rate': None,  # DO NOT MODIFY - leave existing rate
        'states': {
            # Bhutanese sales tax is uniform across all dzongkhags
        }
    },
    ...
    'NP': {  # Nepal - Uniform VAT
        'name': 'Nepal',
        'tax_type': 'vat',
        'federal_rate': None,  # DO NOT MODIFY - leave existing rate
        'states': {
            # Nepalese VAT is uniform across all provinces (despite federal structure)
        }
    },
    ...
    'VN': {  # Vietnam - Uniform VAT
        'name': 'Vietnam',
        'tax_type': 'vat',
        'federal_rate': None,  # DO NOT MODIFY - leave existing rate
        'states': {
            # Vietnamese VAT is uniform across all provinces
        }
    },
    ...
    'MN': {  # Mongolia - Uniform VAT
        ...
        'federal_rate': None,  # DO NOT MODIFY - leave existing rate
        'states': {
            # Mongolian VAT is uniform across all aimags
        }
    },
    'KP': {  # North Korea - Centralized economy
        'name': 'North Korea',
        'tax_type': 'sales_tax',
        'federal_rate': None,  # DO NOT MODIFY - leave existing rate
        'states': {
            # North Korea has centralized economy with limited market taxation
        }
    },
    'TL': {  # Timor-Leste - Limited tax system
        ...
        'federal_rate': None,  # DO NOT MODIFY - leave existing rate
        'states': {
            # Timor-Leste has developing tax system
        }
    },
...
def add_subnational_rates():
    ...
    print("Starting Batch 15: Adding ONLY sub-national tax rates (NO country rate changes)...")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("✅ Batch 15: Sub-national tax rates update complete!")
    ...
    print("\n" + "=" * 60)
    print("KEY FINDINGS:")
    print("  - South Asian countries have uniform VAT despite federal structures")
    print("  - Central Asian post-Soviet states maintain centralized VAT systems")
    print("  - Southeast Asian countries generally have uniform national rates")
    print("  - Developing countries prioritize administrative simplicity")
    print("  - Even federal Nepal maintains uniform VAT across provinces")
    print("  - Socialist/centralized economies avoid regional tax variations")
