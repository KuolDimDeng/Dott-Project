...
echo "============================================="
echo " 🚀 CREATING APP RUNNER SERVICE (HEALTH-ONLY)"
echo "============================================="
...
# Generate a strong SECRET_KEY for Django (even though we're in health-only mode)
...
echo "ℹ️  Creating App Runner service with health-only configuration..."
