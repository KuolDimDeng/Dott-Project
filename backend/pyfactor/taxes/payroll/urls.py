...
urlpatterns = [
    ...
    path('state/process/<str:payroll_run_id>/', StatePayrollProcessorView.as_view(), name='state-payroll-process'),
    path('state/withholding/', StateWithholdingView.as_view(), name='state-withholding'),
