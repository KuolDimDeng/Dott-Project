...
class Customer(TenantAwareModel):
    ...
    billing_county = models.CharField(max_length=100, blank=True, null=True, help_text='County for billing address')
    ship_to_name = models.CharField(max_length=255, blank=True, null=True)
    shipping_country = models.CharField(max_length=100, blank=True, null=True)
    shipping_state = models.CharField(max_length=100, blank=True, null=True)
    shipping_county = models.CharField(max_length=100, blank=True, null=True, help_text='County for shipping address')
