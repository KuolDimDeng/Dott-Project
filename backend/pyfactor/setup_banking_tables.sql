...
-- Add account_id to banktransaction
ALTER TABLE banking_banktransaction
ADD COLUMN account_id UUID REFERENCES banking_bankaccount(id) ON DELETE CASCADE;

-- Add content types for banking models
