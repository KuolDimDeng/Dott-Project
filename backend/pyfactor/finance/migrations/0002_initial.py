...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='financetransaction',
            name='tenant',
            field=models.ForeignKey(help_text='The tenant this record belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='custom_auth.tenant'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='account',
            index=models.Index(fields=['tenant', 'account_number'], name='finance_acc_tenant__d14614_idx'),
        ),
        migrations.AddIndex(
            model_name='account',
            index=models.Index(fields=['tenant', 'business', 'account_type'], name='finance_acc_tenant__20b32c_idx'),
        ),
        migrations.AddIndex(
            model_name='account',
            index=models.Index(fields=['tenant', 'status'], name='finance_acc_tenant__99d7fd_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='budget',
            index=models.Index(fields=['tenant', 'business', 'fiscal_year'], name='finance_bud_tenant__ced4b3_idx'),
        ),
        migrations.AddIndex(
            model_name='budget',
            index=models.Index(fields=['tenant', 'status'], name='finance_bud_tenant__69cc57_idx'),
        ),
        migrations.AddIndex(
            model_name='budget',
            index=models.Index(fields=['tenant', 'category'], name='finance_bud_tenant__eb69ac_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='financetransaction',
            index=models.Index(fields=['tenant', 'transaction_id'], name='finance_fin_tenant__cb6783_idx'),
        ),
        migrations.AddIndex(
            model_name='financetransaction',
            index=models.Index(fields=['tenant', 'account', 'date'], name='finance_fin_tenant__d82bea_idx'),
        ),
        migrations.AddIndex(
            model_name='financetransaction',
            index=models.Index(fields=['tenant', 'category', 'status'], name='finance_fin_tenant__696fe0_idx'),
        ),
        migrations.AddIndex(
            model_name='financetransaction',
            index=models.Index(fields=['tenant', 'business'], name='finance_fin_tenant__8bd1c1_idx'),
        ),
        migrations.AddConstraint(
            model_name='financetransaction',
            constraint=models.UniqueConstraint(fields=('tenant', 'transaction_id'), name='unique_transaction_id_per_tenant'),
        ),
        migrations.AddIndex(
            model_name='financialstatement',
