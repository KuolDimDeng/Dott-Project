...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='account',
            index=models.Index(fields=['tenant_id', 'account_number'], name='finance_acc_tenant__d14614_idx'),
        ),
        migrations.AddIndex(
            model_name='account',
            index=models.Index(fields=['tenant_id', 'business', 'account_type'], name='finance_acc_tenant__20b32c_idx'),
        ),
        migrations.AddIndex(
            model_name='account',
            index=models.Index(fields=['tenant_id', 'status'], name='finance_acc_tenant__99d7fd_idx'),
        ),
        migrations.AddConstraint(
            model_name='account',
            constraint=models.UniqueConstraint(fields=('tenant_id', 'account_number'), name='unique_account_number_per_tenant'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='budget',
            index=models.Index(fields=['tenant_id', 'business', 'fiscal_year'], name='finance_bud_tenant__ced4b3_idx'),
        ),
        migrations.AddIndex(
            model_name='budget',
            index=models.Index(fields=['tenant_id', 'status'], name='finance_bud_tenant__69cc57_idx'),
        ),
        migrations.AddIndex(
            model_name='budget',
            index=models.Index(fields=['tenant_id', 'category'], name='finance_bud_tenant__eb69ac_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='financetransaction',
            index=models.Index(fields=['tenant_id', 'transaction_id'], name='finance_fin_tenant__cb6783_idx'),
        ),
        migrations.AddIndex(
            model_name='financetransaction',
            index=models.Index(fields=['tenant_id', 'account', 'date'], name='finance_fin_tenant__d82bea_idx'),
        ),
        migrations.AddIndex(
            model_name='financetransaction',
            index=models.Index(fields=['tenant_id', 'category', 'status'], name='finance_fin_tenant__696fe0_idx'),
        ),
        migrations.AddIndex(
            model_name='financetransaction',
            index=models.Index(fields=['tenant_id', 'business'], name='finance_fin_tenant__8bd1c1_idx'),
        ),
        migrations.AddConstraint(
            model_name='financetransaction',
            constraint=models.UniqueConstraint(fields=('tenant_id', 'transaction_id'), name='unique_transaction_id_per_tenant'),
        ),
        migrations.AddIndex(
            model_name='financialstatement',
