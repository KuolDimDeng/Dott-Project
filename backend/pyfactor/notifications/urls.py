...
urlpatterns = [
    ...
    path('admin/users/<int:user_id>/', admin_user_management.AdminUserDetailView.as_view(), name='admin-user-detail'),
    path('admin/users/<int:user_id>/block/', admin_user_management.AdminUserBlockView.as_view(), name='admin-user-block'),
