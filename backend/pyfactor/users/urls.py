...
from .api.currency_views import get_currency_list_view, get_currency_preferences, update_currency_preferences, get_exchange_rate
...
urlpatterns = [
    ...
    path('api/currency/preferences/update/', update_currency_preferences, name='update_currency_preferences'),
