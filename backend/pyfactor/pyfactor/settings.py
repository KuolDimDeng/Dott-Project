...
AUTH0_CUSTOM_DOMAIN = os.getenv('AUTH0_CUSTOM_DOMAIN', os.getenv('AUTH0_DOMAIN', 'auth.dottapps.com'))  # Custom domain from env
...
# Always use actual tenant domain for JWKS, custom domain for issuer validation
AUTH0_ISSUER_DOMAIN = AUTH0_CUSTOM_DOMAIN  # Use custom domain for issuer validation
