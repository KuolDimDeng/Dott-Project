...
export default function App() {
  // Use test auth screen to debug redirect URI issues
  const USE_TEST_AUTH = true;
      ...
      <AuthProvider>
        <NavigationContainer>
          <Stack.Navigator initialRouteName="Login">
            <Stack.Screen 
              name="Login" 
              component={USE_TEST_AUTH ? TestAuthScreen : (USE_SIMPLE_AUTH ? SimpleAuth0LoginScreen : (USE_AUTH0_LOGIN ? Auth0LoginScreen : LoginScreen))} 
